        ...
        <h3 class="align-center">Liste des utilisateurs</h3>
            ...
            <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td><?php echo link_to_route('user.edit', 'Modifier', [$user->id], ['class' => 'btn green','style' =>'color:white;']); ?></td>
                    <td>
                        <?php echo Form::open(['method' => 'DELETE', 'route' => ['user.destroy', $user->id]]); ?>

                            <?php echo Form::submit('Supprimer', ['class' => 'btn red','style' =>'color:white;', 'onclick' => 'return confirm(\'Vraiment supprimer cet utilisateur ?\')']); ?>
