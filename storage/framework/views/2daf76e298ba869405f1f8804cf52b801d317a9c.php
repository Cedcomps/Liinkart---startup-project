...
<div class="container">
    <div class="row">
        <div class="col s12 m10 offset-m1">
           <?php echo Form::model($user, ['route' => ['user.update', $user->id], 'method' => 'put', 'class' => 'form-horizontal panel', 'files' => true]); ?>
                ...
                <div class="form-group <?php echo $errors->has('avatar') ? 'has-error' : ''; ?>">
                    <?php echo Form::file('avatar', ['class' => 'form-control', 'placeholder' => 'Avatar']); ?>
