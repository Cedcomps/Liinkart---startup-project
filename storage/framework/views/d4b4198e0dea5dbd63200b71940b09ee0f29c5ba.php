<form action="<?php echo e(route('messages.store')); ?>" method="post" class="col s12">
    ...
    <div class="row">
        ...
        <div class="input-field col s12">
            ...
            <input type="text" class="form-control" name="subject" placeholder="Je vous propose une offre pour votre oeuvre" value="<?php echo e(old('subject') or "Je vous propose une offre pour votre oeuvre"); ?>">
        </div>
