          ...
          <div class="container">
            <div class="row">
              ...
              <div class="valign-wrapper">
                ...
                <p class="grey-text text-lighten-4" style="margin-top: 5px;">Découvrez les talents de demain - Laissez quelqu'un évaluer votre art, il peut valoir plus que ce que vous ne l'imaginiez !</p>
              </div>
              <div class="col l5 m4 s12">
                ...
                <a class="waves-effect waves-light red lighten-3 btn" href="<?php echo e(url('contact')); ?>">CONTACT</a>
              </div>
