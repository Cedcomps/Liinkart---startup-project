...
<div class="container center">
	<div class="row">
	    <div class="col s12 offset-m4 m4">
			<img class="responsive-img weblogo" src="{{ asset ('uploads/weblogo/liinkart-idea.png') }}" alt="idée de liinkart">
	    </div>
        <div class="col s12">
            <div class="section">
    ...
    <div class="divider"></div>
     <div class="row">
	    <div class="col s12 offset-m4 m4">
			<img class="responsive-img weblogo" src="{{ asset ('uploads/weblogo/logo-works.png') }}" alt="Fonctionnement liinkart">
	    </div>
    ...
    <div class="row">
        <div class="col s12 offset-m2 m8 offset-l3 l6">
            ...
            <div class="section">
                ...
                <img class="responsive-img weblogo" src="{{ asset ('uploads/weblogo/liinkart-next.png') }}" alt="Suite de liinkart">
    ...
    <br><a class="waves-effect waves-light btn" href="{{ url('contact') }}">DONNEZ VOTRE AVIS</a></p>
</div>
@endsection
