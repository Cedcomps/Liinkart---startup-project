...
<header>
    <div class="row center">
        ...
        <a class="waves-effect waves-light btn-large" href="{{ route('artworks.index')}}">TROUVER UNE OEUVRE</a>
        <a class="waves-effect waves-light btn-large" href="{{ route('artworks.create')}}">POSTER UNE OEUVRE</a>
    </div>
</header>
<span id="liinkart">
    ...
    <div class="container">
        <div class="row">
            <div class="col s12 m6">
                <img class="responsive-img" src="{{ asset ('uploads/mockup artiste.png') }}" alt="artiste mockup liinkart">
            </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col s12 m6 mockup2">
                <img class="responsive-img" src="{{ asset ('uploads/mockup acheteur.png') }}" alt="acheteur mockup liinkart">
            </div>
        </div>
    </div>
</section>
    ...
    <div class="row">
        <div class="container">
            <div class="col s12 m6 center">
                ...
                <p class="subheading">Consultez les <a href="{{ route('faq') }}">FAQ</a>.</p>
            </div>
            <div class="col s12 m6 center">
                <i class="material-icons">contact_mail</i>
                <h4 class="light">Besoin d'un support?</h4>
                <p class="subheading">Accédez au <a href="{{ url('contact') }}">Centre d'aide de LiinkART</a>.</p>
            </div>
        </div>
    </div>
</section>
