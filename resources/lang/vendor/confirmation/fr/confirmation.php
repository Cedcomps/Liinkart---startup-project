...
return [
    ...
    'email-welcome' => 'Nous vous souhaitons la bienvenue sur la plateforme LiinkART.',
    'email-intro' => 'Confirmez votre adresse email afin de finaliser votre compte LiinkART. C\'est simple, cliquez simplement sur le bouton ci-dessous.',
    ...
    'again' => 'Vous devez valider votre email avant de pouvoir accéder à ce site. ' .
                ...
                '<br>Pour recevoir à nouveau un email de confirmation <a href="' . url('confirmation/resend') . '" class="alert alert-info">cliquez ici</a>.',
